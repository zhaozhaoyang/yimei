...
.tim{color: #999;margin-top: 3px;}
.bspan{display: inline-block;width: 50%;height: 40px;vertical-align: middle;}
.bspan span{display: block;margin-top: 5px;}
...
.c99{color: #999;margin-left: 5px;margin-top: 8px;}
.b3{background: #fff;position: relative;}
...
.cblue{color: #2076FF;}
.pttit{height: 50px;line-height: 60px;font-size: 13px;}
...
.ci{
  height:83px;width:100px;margin:5px 10px 4px 0;border-radius: 3px;
}
...
.line{height: 6px;width: 100%;background:#FAFAFA; }
...
.avtor4{width: 44px;border-radius: 12px;}
.s1{position: absolute;right: 10px;top:12px;display: block;width: 60px;height: 22px;border-radius: 5px;color: #fff;background: #2076FF;text-align: center;line-height: 22px;font-size: 14px;}
.s2{position: absolute;right: 10px;top:20px;display: block;width: 81px;height: 26px;border-radius: 13px;color: #fff;background: #2076FF;text-align: center;line-height: 26px;font-size: 13px;}
</style>
